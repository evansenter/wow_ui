...
AngryAssign_Pages = {
	...
	[3009040956] = {
		...
		["Id"] = 3009040956,
		["UpdateId"] = 3641582910,
		["Contents"] = "Healing CDS (Lust):\n1)Keezyo\n2)Evan (Hymn)\n3)Luumi\n4)Zarana (Hymn)\n\nInterrup Order:\n1)Brun (Hex)\n2)Rein (Key)\n3)Kemsa (Grim)\n\nG1,G2: Purple > Skull\nG3,G4: Square > Circle\n\nAdds= Fire > Wall > Lightning > Aman'Thul\n\nMoon: Cody + Fear\nRed: Keezyo + Athenie\nGreen: Brun + Sinestro\nStar: DJ + Reign\n\nWarlocks: 1(Fear) 2(Demon) 3(Sinestro) 4(Alys) 5(athenia)",
	},
	[664173253] = {
		["Updated"] = 1426210323,
		["Name"] = "Grull 2.0",
	...
	[1036418640] = {
		...
		["Id"] = 1036418640,
		["UpdateId"] = 950832543,
		["Backup"] = "Priority:\nTendril (H) > Dark Young > Eyes\n\nGroup 1 (L):\nXorn, Rein, Jammed\n\nGroup 2 (R):\nDemon, Kemsa, Moral\n\nGroup 3 (L):\nDerail, Ulrix\n\nHealer support: Evan (5), Redexx (6)",
		["Contents"] = "Priority:\nTendril (H) > Dark Young > Eyes\n\nGroup 1 (L):\nXorn, Rein, Jammed\n\nGroup 2 (R):\nDemon, Kemsa, Moral\n\nGroup 3 (L):\nDerail, Ulrix\n\nHealer support: Evan (5), Redexx (6)",
	},
	[1170303878] = {
		["Updated"] = 1426729837,
	...
	[524139627] = {
		...
		["Id"] = 524139627,
		["UpdateId"] = 2672197866,
		["Contents"] = "POD 1 - DJ Zarana (BACKUP key)\nPOD 2 - sinestro reed (BACKUP azad )\nPOD 3 - reign rage  ( BACKUP gliere )\nPOD 4 - keezyo evan (BACKUP brun)\nPOD 5 - THENEX jarinia (BACKUP ANYONE)\n\n\nFUSILLADES:\n1) luu (Wings+HA) \n2) Keez (Tranq)\n3) Comet(hymn)\n\n4) Zarana (hymn)\n5) Dj (slink)\n6) Dj(tide) + reed darkness\n\n7) Rage(darkness)+ Keez (tranq) + Zarana(hymn)\n8) Comet(hymn)  + DJ (link) + DJ(tide)\n9) Amanita(tide) + luu (Wings+HA)",
	},
	[3476819744] = {
		["Updated"] = 1510882719,
		["Name"] = "host",
	...
	[4110550103] = {
		...
		["Id"] = 4110550103,
		["UpdateId"] = 1146988392,
		["Backup"] = "Lust P3\n\nFlame Rends/Empowered FR\n1st - G1/G2 {square}\n2nd - G3/G4 {diamond}\n\nHeal CD’s\n1:30 - 1st Double: Taz Link, Hex Tide,Lumi AM+Wings,\nZara Hymn\n1:55 - 2nd Double: Hex Link,Taz Tide, Lumi HA,\nKeezyo Tranq-PERSONALS\n5:00 - 3rd Double: Taz Link, Hex Tide,Lumi AM,\nZara Hymn\n\nP3 Flares:\nOdds-Gateways\nEvens: Hex/Taz-WR Totems",
		["Contents"] = "Lust P3\n\nFlame Rends/Empowered FR\n1st - G1/G2 {square}\n2nd - G3/G4 {diamond}\n\nHeal CD’s\n1:30 - 1st Double: Taz Link, Hex Tide,Lumi AM+Wings,\nZara Hymn\n1:55 - 2nd Double: Hex Link,Taz Tide, Lumi HA,\nKeezyo Tranq-PERSONALS\n5:00 - 3rd Double: Taz Link, Hex Tide,Lumi AM,\nZara Hymn\n\nP3 Flares:\nOdds-Gateways\nEvens: Hex/Taz-WR Totems",
	},
	[1139106633] = {
		["Updated"] = 1513735215,
	...
	[3762303581] = {
		...
		["Id"] = 3762303581,
		["UpdateId"] = 2854071832,
		["Backup"] = "||cred[Intermission Phases]\n||cpriestEvan Hymn\n||cshamanHex CBT Pump\n||cwarriorKemsa Shout\n||cshamanHex HTT out of Phase\n\n\n[Phase 2]\n\n||cred[Double Pop]\n||cpaladinLuumii AM\n||cdemonhunterRage Darkness\n||cpriestZarana Hymn\n||cshamanHex Link\n||cshamanHex CBT\n\n||cgreen[Single Pop]\n||cdemonhunterMoralcunt Darkness\n||cdruidKeezyo Tranq (SUBJ.)\n\n||cgreen[Single Pop]\n||cdemonhunterReed Darkness",
		["Contents"] = "||cred[Intermission Phases]\n||cpriestEvan Hymn\n||cshamanHex CBT Pump\n||cwarriorKemsa Shout\n||cshamanHex HTT out of Phase\n\n\n[Phase 2]\n\n||cred[Double Pop]\n||cpaladinLuumii AM\n||cdemonhunterRage Darkness\n||cpriestZarana Hymn\n||cshamanHex Link\n||cshamanHex CBT\n\n||cgreen[Single Pop]\n||cdemonhunterMoralcunt Darkness\n||cdruidKeezyo Tranq (SUBJ.)\n\n||cgreen[Single Pop]\n||cdemonhunterReed Darkness",
	},
	[540890002] = {
		["Updated"] = 1425959449,
		["Name"] = "Blackhand",
	...
	[1950355341] = {
		...
		["Id"] = 1950355341,
		["UpdateId"] = 2249568986,
		["Contents"] = "Portal 1 = dj(yellow), jar(red), brun(blue), demon(green).\n\nPortal 2 = evan(yellow), thenex(red), blight(blue), gliere(green).\n\nPortal 3 = zarana(yellow), reign (red),key (blue), rage(green).\n\nPortal 4 = keezyo(yellow), reed(red) azad (blue), packa(green).\n\nGROUP A = group 1 and 2\n\nGROUP B = group 3 and 4",
	},
	[1553583750] = {
		["Updated"] = 1419902031,
		["Name"] = "Rock bitch",
	...
	[1415908480] = {
		...
		["Id"] = 1415908480,
		["UpdateId"] = 2807102242,
		["Contents"] = "Portttal Group:\nRein, dj, thereign, reed, brun, azad,jarinia rage blight\n\n\nTEAM SHORT BUS -  dj jar brun\nCC Rotation:\n\nyarra,key",
	},
	[947221404] = {
		["Updated"] = 1545357079,
		["Name"] = "G'huun",
		["Id"] = 947221404,
		["UpdateId"] = 1339635166,
		["Contents"] = "Team 1\nL - Comet || R - Lan\nTeam 2\nL - Bromsi,TBV || R - Boody, Sauce\nTeam 3 \nL - Mebrick, Kggs || R - Papa\nTeam 4 \nL - Rocker, Gateboi || R - Laz, Tent\nTeam 5\nL - Shen, || R - Ray\n\nGrp 1: Diamond\nGrp 2: X\nGrp 3: Square\nGrp 4: Triangle\n\nFeast 1 - everyone \nFeast 2 - everyone || Feast then boil soak\nFeast 3 - Team 1,4 || Boil Soak then feast\nFeast 4 - everyone || Boil Soak then feast\n\np1\nexplosive corruptions\n1 (0:15) - AC\n2 (1:00) - Dgen Revival\nblast (1:30) - initiate hymn + barrier\n\np2\nchatters \nadd 1, 2nd chatter (~2:45) - AM + salv\nps on Bubby\nbeam blast (~3:45) - Dgen Revival + Shadowfiend\n\np3\nchatter (~5:00)\nadd 1, 2nd chatter - AC\nblast - initiate hymn\ncollapse - Rally/Dark, Bubble/Comet revival\n\np4\nLumi ac\nshadowfiend\nDan Salv\nlumi am\nTranq\nhymn\nRevival\nRevival\nWhatever else",
	},
	[1763909478] = {
		["Updated"] = 1421207437,
		["Name"] = "Brakenspore",
	...
	[1827315877] = {
		...
		["Id"] = 1827315877,
		["UpdateId"] = 2095958167,
		["Contents"] = "GROUP 1 - Trick reed moral\n\nGROUIP 2 - evan thenex barmonk\n\nGROUP 3 - blight kemsa braveruy\n\nGROUP 4 - demon jar brun\n\nGROUP 5- zarana hidder xorn",
	},
	[975215370] = {
		["Updated"] = 1419911048,
		["Name"] = "Twins Redux",
	...
	[3302637128] = {
		...
		["Id"] = 3302637128,
		["UpdateId"] = 990928145,
		["Contents"] = "Left {star} Meta/Comet\n- Viudoo\n- Breaktheice\n- Meta\n\nRight {diamond} Boody/Initiate\n- Boody\n- Exo\n- Initiate\n\nCDS\n{skull}Xal 1{skull}\nEchoes 1 - Tree / Rev if poss\nEchoes 2 - Tranq / Rev if poss\n{skull}Xal 2{skull}\nEchoes 1 - Disc Bubble on Melee\nEchoes 2 - Hymn\n\nTransition  - AM + Ray Darkness",
	},
	[1420409201] = {
		["Updated"] = 1515554413,
		["Name"] = "command",
	...
	[266927433] = {
		...
		["Id"] = 266927433,
		["UpdateId"] = 434050642,
		["Contents"] = "{star} Group 1 - 4\n{circle} Group 2  - 4\n{diamond} Group 3 - 5\n{triangle} Group 4 - 5\n\n:20 - Contagion 1/5 - Meta Tranq \n:43 - Contagion 2/6 -   Ray Darkness + AM\n1:06 - Contagion 3/7 - Bubble + Shen Darkness\n\nIntermission: Salvation dan \n\n2:39 - Contagion 4/8 - Meta Tranq \n2:59 - Contagion 5/9 -  Hymn\n3:16 - Contagion 6/10 - Rev + Ray Darkness\n\nIntermission2: Tree",
	},
	[1548764330] = {
		["Updated"] = 1499387417,
		["Name"] = "1Goroth",
	...
	[1927737388] = {
		...
		["Id"] = 1927737388,
		["UpdateId"] = 1537219403,
		["Contents"] = "Pool Soak\np1 - Initiate, Lan, Meta, Sauce\np2 - Rocker. Dog, Viudoo, Ouro,, Luumi\n\nBloodhexer CC: Ouro,Viudoo\nDebuff Purger:Sauce\n\nRev MD:\nBloody X\nInitiate Diamond\n\nDeathwishes:\n1. Initiate clenase > initiate grip 2nd > boody MD > boody clenase > initate MD\n2. Boody clenase > boody grip 2nd > intiate MD > initiate clenase > boody MD\n\nHeal CD:\nRev 1 : Hymn\nRev 2 : Devo\nPhasing: Bubble,, Rally\nDW 1 : Salv + Ray\nDW 2 : tranq + Shen",
	},
}
