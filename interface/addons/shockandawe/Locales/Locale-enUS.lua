...
local L = LibStub("AceLocale-3.0"):NewLocale("ShockAndAwe", "enUS", true, debug);
...
L["help"] = "All options can be configured more easily using the Blizzard options menu. Press ESC and select addons then click on ShockAndAwe to configure."
L["help1"] = "All options can be configured more easily using the Blizzard options menu."
L["help2"] = "Press ESC and select addons then click on ShockAndAwe to configure."
...
L["help_unleash"] = "Activate or deactivate the Unleash Elements bar."
L["help_ElementalBlast"] = "Activate or deactivate the Elemental Blast bar."
...
L["help_stonebulwark"] = "Activate or deactivate the Stone Bulwark Totem Bar"
L["help_wfOverlay"] = "Activate or deactivate to overlay the Storm Strike Bar with the Windfury Bar."
...
L["help_news"] = "Display the latest news item about ShockAndAwe"
...
L["help_hwhealth"] = "Percentage of health remaining to recommend Healing Surge."
...
L["help_chingroup"] = "Displays Chain Heal instead of Healing Surge when health is below Healing Surge Health% while you are in a group."
...
L["Unleash Elements Bar"] = true
L["Elemental Blast Bar"] = true
...
L["Stone Bulwark Totem Bar"] = true
L["Windfury Bar Overlay"] = true
L["Bar Font"] = true
...
L["config_Unleash_on"] = "Unleash Elements bar will now be displayed when cast"
L["config_Unleash_off"] = "Unleash Elements bar will NOT now be displayed when cast"
L["config_ElementalBlast_on"] = "Elemental Blast bar will now be displayed when cast"
L["config_ElementalBlast_off"] = "Elemental Blast bar will NOT now be displayed when cast"
...
L["config_sb_on"] = "Stone Bulwark Totem bar will now be displayed when cast"
L["config_sb_off"] = "Stone Bulwark Totem will NOT now be displayed when cast"
L["config_wfoverlay_on"] = "The Storm Strike Bar will now be overlayed with the Windfury Bar."
L["config_wfoverlay_off"] = "The Storm Strike Bar will NOT be overlayed with the Windfury Bar."
...
L["config_LL_on"] = "Lava Lash bar will now be displayed"
L["config_LL_off"] = "Lava Lash  bar will NOT now be displayed"
...
L["config_hwhealth"] = "Max health to recommend Healing Surge set to : "
L["config_chingroup_on"] = "When grouped, priority window will now show Chain Heal instead of Healing Surge."
L["config_chingroup_off"] = "When grouped, priority window will now show Healing Surge instead of Chain Heal."
...
L["You have changed to a new talent spec do you want to enable ShockAndAwe?"] = true
L["You have changed to a new talent spec do you want to disable ShockAndAwe?"] = true
L["You are in Enhancement spec do you want to enable ShockAndAwe?"] = true
L["You are NOT in Enhancement spec do you want to disable ShockAndAwe?"] = true
...
L["Primary Shield Stone Bulwark Totem"] = true
L["Secondary Shield Stone Bulwark Totem"] = true
L["Depleted Stone Bulwark Totem"] = true
L["CD Stone Bulwark Totem"] = true
L["Flurry Colour"] = true
L["Fire Bar Colour"] = true
L["Unleash Elements Bar Colour"] = true

L["colUnleash"] = "Select which colour you want to use when unleash elements is active"
...
L["primarySBTDesc"] = "Select which colour to show on Stone Bulwark Totem bar when the primary shield is active."
L["secondarySBTDesc"] = "Select which colour to show on Stone Bulwark Totem bar when the secondary shield is active."
L["depletedSBTDesc"] = "Select which colour to show on Stone Bulwark Totem bar when the totem is depleted."
L["cdSBTDesc"] = "Select which colour to show on Stone Bulwark Totem bar when the totem is on cooldown."
...
L["MW5 Healing Surge"] = true
L["MW4 Lightning Bolt"] = true
L["MW3 Lightning Bolt"] = true
L["MW2 Lightning Bolt"] = true
L["MW1 Lightning Bolt"] = true
L["MW4 Chain Lightning"] = true
L["MW4 Healing Surge"] = true
...
L["Unleash Elements if Unleashed Fury is known"] = true
L["Lava Lash 5 Searing Flames"] = true
L["Lava Lash 4 Searing Flames"] = true
L["Lava Lash 3 Searing Flames"] = true
L["Lightning Bolt if Ancestral Swiftness is up"] = true
L["Chain Lightning if Ancestral Swiftness is up"] = true
L["Flame Shock if Unleash Flame"] = true
L["Ancestral Swiftness if MW < 2"] = true
L["MW>3_LB_UF"] = true
L["MW>1_LB"] = true
L["FS_UEF"] = true
L["None"] = true
...
L["Keybind Title"] = "ShockAndAwe Keybinds"
