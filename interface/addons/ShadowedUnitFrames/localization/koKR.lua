...
L["Advanced"] = "고급 옵션"
L["Advanced tag management, allows you to add your own custom tags."] = "고급 태그 관리, 사용자 정의 태그를 추가하거나 수정할 수 있습니다."
L["AFK"] = "자리 비움"
...
L["Alternatively friendly spell to use to check range."] = "사거리를 확인하는 데 사용하는 다른 우호 주문입니다."
L["Ammo"] = "탄약류"
...
L["Assigned Role (DPS/Tank/etc)"] = "할당된 역할 (딜러/탱커/ 등)"
L["Astral Power"] = "천공의 힘"
L["Aura border style"] = "오라 외곽선 스타일"
L["Aura borders"] = "오라 외곽선"
...
L["Background/border"] = "배경/외곽선"
L["Bag indicator for master looters."] = "담당자 룻 표시를 위한 가방 표시기"
L["Bar alpha"] = "바 투명도"
L["Bar spacing"] = "바 간격"
L["Bar texture"] = "바 무늬"
L["Bars"] = "바"
...
L["Blizzard"] = "블리자드창"
L["Border"] = "외곽선"
L["Border alpha"] = "외곽선 투명도"
L["Border color"] = "외곽선 색상"
L["Border coloring of stealable, curable and dispellable auras."] = "훔치기, 치유 및 해제 가능한 오라의 외곽선 색상 입힘"
L["Border highlighting"] = "외곽선 강조"
L["Border thickness"] = "외곽선 두께"
L["Boss"] = "보스"
L["Boss Auras"] = "보스 오라"
...
L["Changes the health bar to the set hostile color (Red by default) when the unit takes aggro."] = "유닛이 어그로를 획득한 경우 체력바를 설정한 적 색상(기본값: 빨간색)으로 바꿉니다."
L["Changes this widget into a bar, you will be able to change the height and ordering like you can change health and power bars."] = "이 위젯을 바로 변경, 체력 및 자원 바처럼 높이와 순서를 바꿀 수 있습니다."
L["Channelling"] = "채널링"
...
L["Class icon"] = "직업 아이콘"
L["Class Icon"] = "직업 아이콘"
L["Class icon for players."] = "플레이어용 직업 아이콘"
...
L["Cur/Max power (Absolute)"] = "현재/최대 자원 (절대값)"
L["Cur/Max power (Druid)"] = "현재/최대 파워 (드루이드)"
L["Cur/Max power (Druid/Absolute)"] = "현재/최대 자원 (드루이드/절대값)"
L["Cur/Max power (Secondary/Absolute)"] = "현재/최대 자원 (Secondary/절대값)"
...
L["Current power (Absolute)"] = "현재 자원 (절대값)"
L["Current power (Druid)"] = "현재 파워(드루이드)"
L["Current power (Druid/Absolute)"] = "현재 자원 (드루이드/절대값)"
L["Current power (Secondary/Absolute)"] = "현재 자원 (Secondary/절대값)"
...
L["Descending"] = "역순(거꾸로)"
L["Disable Auras by Class"] = "직업별 미사용 오라"
L["Disable OmniCC"] = "OmniCC 사용 안 함"
L["Disable vehicle swap"] = "차량 전환 사용 안 함"
L["Disabled"] = "비활성(끔)"
L["Disabled in %s"] = "%s 비활성(꺼짐)."
L["Disables showing OmniCC timers in all Shadowed Unit Frame auras."] = "모든 SUF 오라에 OmniCC 타이머 표시를 사용하지 않습니다."
...
L["DND:%s"] = "다른용무:%s"
L["Documentation"] = "문서"
L["Don't hide when empty"] = "빈 경우 숨기지 않음"
...
L["Export"] = "내보내기"
L["F"] = "F"
L["Fades out the unit frames of people who are not within range of you."] = "사거리 안에 없는 대상의 유닛창을 점점 사라지게 합니다."
...
L["Health"] = "체력"
L["Health bar"] = "체력 바"
L["Health bar color for friendly units."] = "우호 유닛의 체력 바 색상"
L["Health bar color for hostile units."] = "적 유닛의 체력 바 색상입니다."
...
L["Hide bar when empty"] = "빈 바 숨김"
L["Hide Blizzard"] = "블리자드 창 숨김"
L["Hide in <=5-man raids"] = "5인 이하 레이드에서 숨김"
L["Hide in >5-man raids"] = "5인 초과 레이드에서 숨김"
L["Hide in any raid"] = "모든 공격대에서 숨김"
L["Hide tooltips in combat"] = "전투 중 툴팁 숨김"
L["Hides the cast bar if there is no cast active."] = "만약 시전 중이 아닐 경우 시전바를 숨깁니다."
L["Hides the power bar unless the class has mana."] = "마나 있는 직업 이외에는 자원 바 숨김"
...
L["Holy Power"] = "신성한 힘"
L["Hostile"] = "적대적"
L["How close the frame should clip with the border."] = "프레임 외곽선과의 간격을 조절합니다."
L["How far the background should be from the unit frame border."] = "유닛 창 외곽선으로부터 배경 삽입 위치."
...
L["Max power (Absolute)"] = "최대 자원 (절대값)"
...
L["Name of a friendly spell to check range."] = "사거리를 확인하는 우호 주문의 이름입니다."
L["Neutral"] = "중립적"
...
L["PvP Flag"] = "PvP 깃발"
L["PVP flag indicator, Horde for Horde flagged pvpers and Alliance for Alliance flagged pvpers."] = "PvP 깃발 표시기."
L["PvP Flags"] = "PvP 깃발"
L["PVP timer"] = "PVP 타이머"
L["PVP:%s"] = "PVP:%s"
L["Quest Boss"] = "퀘스트 보스"
...
L["Raid pet"] = "공격대 소환수"
L["Raid Role"] = "공격대 역할"
L["Raid role indicator, adds a shield indicator for main tanks and a sword icon for main assists."] = "공격대 역할 표시기로 메인 탱커는 방패 모양, 지원담당은 칼 모양입니다."
L["Raid Target"] = "공격대 대상"
L["Raid target indicator."] = "공격대 대상 표시기."
L["Raid targeting unit"] = "공격대 대상 유닛"
L["Range Checker"] = "사거리 확인기"
...
L["Ready Status"] = "준비 상태"
L["Ready status of group members."] = "파티원의 전투 준비 상태."
...
L["Right text"] = "오른쪽 형식"
L["Right Top"] = "오른쪽 상단"
L["Role the unit is playing."] = "유닛이 플레이 중인 역할."
L["Row growth"] = "열 성장"
L["Row offset"] = "행 좌표"
L["Rune bar"] = "룬 바"
...
L["Shows a bar for alternate power info (used in some encounters)"] = "(일부 전투에서 쓰이는) 대체 자원 정보를 위한 바를 표시합니다"
...
L["Shows debuffs cast by a boss."] = "보스가 시전한 디버프 표시."
...
L["Spell Name"] = "주문 이름"
L["Spell Name/ID"] = "주문 명칭/ID"
L["Stagger"] = "시간차"
L["Stagger (Monk)"] = "시간차 (수도사)"
L["Stagger (Monk/Absolute)"] = "시간차 (수도사/절대값)"
L["Stagger bar"] = "시간차 바"
L["Stagger bar color when the staggered amount is <30% of your HP."] = "시간차 양이 HP의 30% 미만일 때 시간차 바 색상입니다."
L["Stagger bar color when the staggered amount is >30% of your HP."] = "시간차 양이 HP의 30% 초과일 때 시간차 바 색상."
L["Stagger bar color when the staggered amount is >70% of your HP."] = "시간차 양이 HP의 70% 초과일 때 시간차 바 색상."
L["Static"] = "일반 체력"
L["Status"] = "상태"
L["Status indicator, shows if the unit is currently in combat. For the player it will also show if you are rested."] = "유닛이 현재 전투 중인 경우를 표시하는 상태 표시기. 플레이어의 경우 휴식 중인 경우에도 표시합니다."
L["Style of borders to show for all auras."] = "모든 오라를 표시하는 외곽선 스타일."
L["T"] = "T"
L["Tag list"] = "태그 목록"
L["Tag name"] = "태그 이름"
L["Tags"] = "태그"
...
L["The unit frames you see are examples, they are not perfect and do not show all the data they normally would.|n|nYou can hide them by locking them through /shadowuf or clicking the button below."] = "지금 보는 유닛 창은 예이며, 완벽하지 않고 보통 보여주는 데이터를 모두 표시하지 않습니다.|n|n/suf나 아래 버튼 클릭을 통해 창을 숨길 수 있습니다."
...
L["Top Left"] = "상단 왼쪽"
L["Top Right"] = "상단 오른쪽"
L["Total number of active holy power."] = "현재 신성한 힘의 총 수"
...
L["You do not have any filters of this type added yet, you will have to create one in the management panel before this page is useful."] = "이 유형의 필터에 아직 추가된 것이 없으므로, 이 페이지를 사용하기 전에 관리 탭에서 필터를 만들어야 합니다."
...
L["Zone configuration units"] = "지역 설정 유닛"
