...
L["Adds a bar inside the health bar indicating how much healing someone will receive."] = "누군가 받은 치유량을 나타내는 바를 생명력 바 내부에 추가합니다."
...
L["Ammo"] = "탄약류"
L["Amount of health missing, if none is missing nothing is shown. Uses a short format, -18500 is shown as -18.5k, values below 10000 are formatted as is."] = "생명력 손실량으로, 없으면 아무것도 표시되지 않습니다. 짧은 형태를 사용해 -18500은 -18.5k로 10000 미만 값은 그대로 표시됩니다."
L["Amount of power missing,  if none is missing nothing is shown. Uses a short format, -13850 is shown as 13.8k, values below 10000 are formatted as is."] = "자원 손실량으로, 없으면 아무것도 표시되지 않습니다. 짧은 형태를 사용해 -13850은 13.8k로 10000 미만 값은 그대로 표시됩니다."
...
L["Changes the health bar to the set hostile color (Red by default) when the unit takes aggro."] = "유닛이 어그로를 취한 경우 생명력 바를 설정된 적대 색상(기본값: 빨간색)으로 바꿉니다."
...
L["Disabled"] = "비활성(끔)"
L["Disabled for %s."] = "%s에 대해 사용하지 않습니다."
...
L["How many auras to show in a single row."] = "한 행에 표시할 오라 개수입니다."
...
L["How the rows should grow when new group members are added."] = "새로운 파티원이 추가될 때 행을 확장하는 방법입니다."
...
L["Medium"] = "중간"
L["Miscellaneous"] = "기타"
L["Missing HP (Short)"] = "손실 생명력 (짧게)"
L["Missing power (Short)"] = "손실 자원 (짧게)"
...
L["Returns text based on the units general threat situation: Aggro for Aggro, High for being close to taking aggro, and Medium as a warning to be wary.|nThis cannot be used on target of target or focus target types of units."] = "유닛 위협 수준 상황을 기반으로 한 텍스트(어그로에 Aggro, 어그로 획득에 가까우면 High, 주의하라는 경고로 Medium)를 반환합니다.|n이는 대상의 대상 또는 주시 대상 유형의 유닛에는 사용될 수 없습니다."
...
L["Returns the color code for the units threat situation in general: Red for Aggro, Orange for High threat and Yellow to watch out.|nThis cannot be used on target of target or focus target types of units."] = "보통 유닛 위협 수준 상황(어그로에 적색, 높은 위협 수준은 주황색, 주의 수준은 노란색)에 따른 색상 코드를 반환합니다.|n이는 대상의 대상 또는 주시 대상 유형의 유닛에는 사용될 수 없습니다."
...
L["Soul shards"] = "영혼의 조각"
L["Spacing"] = "간격"
L["Spacing between each row"] = "각 행 사이의 간격"
...
L["Unchecking this will completely disable aura indicators for %s."] = "이를 선택 해제하면 %s에 대한 오라 표시기를 전혀 사용하지 않습니다."
...
L["Whether to show buffs that you cannot cast."] = "시전할 수 없는 버프를 표시할지 여부입니다."
L["Whitelist"] = "허용목록"
