...
--[[
    ...
    Copyright © 2013 - 2015 Anthony Goins <turncoat@imightstabyou.com>
...
local function nRange_IsActive()
    if class == "WARLOCK" then
        local buff = UnitBuff("player", GetSpellInfo(104135))
        if buff then
    ...
    elseif class == "MONK" then
        local buff = UnitBuff("player", GetSpellInfo(123024))
        if buff then
            nRange_ClassInfo.active = true;
            nRange:Show();
            return true;
