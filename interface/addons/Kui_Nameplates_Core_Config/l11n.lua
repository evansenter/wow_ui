...
opt.tooltips = {
    ...
    fade_untracked = 'Fade non-tracked nameplates by default (including those in nameonly mode). Whether or not a unit is tracked can by set by changing the "NPC Names" dropdown in the default interface options under Esc > Interface > Names',
