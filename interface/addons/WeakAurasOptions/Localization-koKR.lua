...
L["Enabled"] = "활성화됨"
L["End Angle"] = "종료 각도"
L["Enter an aura name, partial aura name, or spell id"] = "효과 이름 / 효과 이름의 일부 / 주문ID를 입력하세요"
L["Event"] = "이벤트"
L["Event Type"] = "이벤트 유형"
L["Event(s)"] = "이벤트"
...
L["Green Rune"] = "녹색 룬"
L["Group"] = "그룹"
L["Group aura count description"] = [=[디스플레이 조건을 충족하기 위해 주어진 효과에 영향을 받는 한명 이상의 %s 멤버의 숫자.
...
L["Preset"] = "프리셋"
L["Prevents duration information from decreasing when an aura refreshes. May cause problems if used with multiple auras with different durations."] = "효과가 갱신 됐을 때 지속시간이 감소 하지 않게 합니다. 다른 지속시간을 가진 여러 효과를 사용할 때 문제가 발생할 수 있습니다."
...
L["Scale"] = "크기 비율"
L["Search"] = "검색"
L["Select the auras you always want to be listed first"] = "목록에서 첫번째로 보여질 효과를 선택하세요"
L["Send To"] = "보내기..."
