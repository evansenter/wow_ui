...
L["WQGF_APPLIED_TO_GROUPS"] = "你已经申请了世界任务 |c00bfffff%s|c00ffffff 的 |c00bfffff%d|c00ffffff. 个队伍。"
L["WQGF_AUTO_LEAVING_DIALOG"] = [=[你已经完成这个世界任务并会在 %d 秒后离开队伍。

说声再见吧！]=]
L["WQGF_CANCEL"] = "取消"
L["WQGF_CANNOT_DO_WQ_IN_GROUP"] = "这个世界任务无法在队伍中完成。"
L["WQGF_CANNOT_DO_WQ_TYPE_IN_GROUP"] = "这项世界任务类型无法在队伍中完成。"
...
L["WQGF_CONFIG_LANGUAGE_FILTER_HOVER"] = "将会搜索所有可加入的队伍，不管它们的语言"
...
L["WQGF_CONFIG_LOGIN_MESSAGE_TITLE_HOVER"] = "不会再于登入时显示WQGF的信息"
L["WQGF_CONFIG_NEW_WQ_AREA_DETECTION_AUTO_ENABLE"] = "如果不在队伍时自动开始搜索"
L["WQGF_CONFIG_NEW_WQ_AREA_DETECTION_AUTO_HOVER"] = "进入新的世界任务地区时会自动搜索队伍"
L["WQGF_CONFIG_NEW_WQ_AREA_DETECTION_ENABLE"] = "开启新的世界任务地区侦测模式"
L["WQGF_CONFIG_NEW_WQ_AREA_DETECTION_HOVER"] = "当进入新的世界任务地区时，你会被询问是否要寻找队伍"
L["WQGF_CONFIG_NEW_WQ_AREA_DETECTION_SWITCH_ENABLE"] = "如果已在其他世界任务队伍中则不提示"
L["WQGF_CONFIG_NEW_WQ_AREA_DETECTION_TITLE"] = "在第一次进入世界任务地区时提示查找队伍"
...
L["WQGF_CONFIG_SILENT_MODE_HOVER"] = "当启用无干扰模式时，只有重要的WQGF信息会显示"
...
L["WQGF_CONFIG_WQ_END_DIALOG_HOVER"] = "当世界任务完成时，会提示离开队伍或从清单中移除"
L["WQGF_CONFIG_WQ_END_DIALOG_TITLE"] = "世界任务完成时显示离开队伍的对话"
L["WQGF_DEBUG_CONFIGURATION_DUMP"] = "角色设定档："
...
L["WQGF_DEBUG_WQ_ZONES_ENTERED"] = "这一次登入所进入的世界任务地区:"
L["WQGF_DELIST"] = "除名"
L["WQGF_GLOBAL_CONFIGURATION"] = "共通选项:"
L["WQGF_GROUP_CREATION_ERROR"] = "尝试建立队伍时出问题了，请重新试一次。"
L["WQGF_GROUP_NO_LONGER_DOING_WQ"] = "你的队伍没有在进行世界任务： |c00bfffff%s|c00ffffff 。"
L["WQGF_GROUP_NOW_DOING_WQ"] = "你的队伍正在进行世界任务：|c00bfffff%s|c00ffffff。"
L["WQGF_GROUP_NOW_DOING_WQ_ALREADY_COMPLETE"] = "你的队伍正在进行： |c00bfffff%s|c00ffffff 。你已经完成这个任务了。"
L["WQGF_GROUP_NOW_DOING_WQ_NOT_ELIGIBLE"] = "你的队伍正在进行： |c00bfffff%s|c00ffffff 。你没办法进行这个任务。"
...
L["WQGF_NO"] = "不要"
L["WQGF_NO_APPLICATIONS_ANSWERED"] = "没有任何一个申请加入 |c00bfffff%s|c00ffffff 的要求于时间内回应。试图寻找新的队伍中..."
...
L["WQGF_RAID_MODE_WARNING"] = "|c0000ffff警告:|c00ffffff 这个队伍处于团队模式中，意味着你将无法完成世界任务。你应该建议队长是否转回队伍模式。当你是此队伍的队长时，将自动切换到队伍模式。"
L["WQGF_SEARCH_OR_CREATE_GROUP"] = "搜索或建立队伍"
L["WQGF_SEARCHING_FOR_GROUP"] = "正在寻找世界任务 |c00bfffff%s|c00ffffff 的队伍..."
...
L["WQGF_WQ_AREA_ENTERED_ALREADY_GROUPED_DIALOG"] = [=[你进入了新的世界任务地区，但在其他世界任务的队伍中。

你想要离开现在的队伍，然后搜索另一个解 "%s" 的队伍吗？]=]
...
想要离开队伍或自队伍搜索器中除名吗？]=]
L["WQGF_WQ_GROUP_APPLY_CANCELLED"] = "你已经取消申请 |c00bfffff%s|c00ffffff 的队伍（世界任务: |c00bfffff%s|c00ffffff）。 WQGF 不会再尝试加入这个团队，直到你重新登入或把队长黑名单清空。"
