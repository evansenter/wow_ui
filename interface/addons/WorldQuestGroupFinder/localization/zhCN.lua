...
L["WQGF_CONFIG_LANGUAGE_FILTER_HOVER"] = "将会搜索所有可加入的队伍，忽略他们的语言"
...
L["WQGF_SEARCHING_FOR_GROUP_QUEST"] = "为任务 |c00bfffff%s|c00ffffff 搜索队伍"
...
L["WQGF_WQ_AREA_ENTERED_ALREADY_GROUPED_DIALOG"] = [=[你进入了新的世界任务地区，但你还在其他世界任务的队伍中。
