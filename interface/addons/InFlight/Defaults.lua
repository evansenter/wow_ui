...
function InFlight:Sanitise(flightPaths, allowUpdates)
		...
		if faction == "Horde" or faction == "Alliance" then
			...
			for source, dt in pairs(t) do
				...
				if source ~= "" and not InFlightVars[faction][source] then
					...
					PrintD(faction, "|cff208080New source:|r", source)
				end
				...
				for dest, utime in pairs(dt) do
					...
					if type(utime) == "number" then
							...
							if vtime then
								if allowUpdates then
									...
									if debug then
										found = true
										updated = updated + 1
										PrintD(faction, "|cff208020Update time:|r", source, "|cff208020to|r", dest, "|cff208020- old:|r", vtime, "|cff208020new:|r", utime)
									end
								end
							elseif dest ~= "" then
								InFlightVars[faction][source][dest] = utime
								if debug then
									found = true
									added = added + 1
									PrintD(faction, "|cff208080New time:|r", source, "|cff208020to|r", dest, "|cff208020- new:|r", utime)
								end
							end
						elseif vtime and vtime < 10 then
							...
							if debug then
								found = true
								removed = removed + 1
								PrintD(faction, "|cff808020Remove time:|r", source, "|cff208020to|r", dest, "|cff208020- old:|r", vtime)
							end
						end
					elseif InFlightVars[faction][source][dest] then
						...
						if debug then
							found = true
							removed = removed + 1
							PrintD(faction, "|cff808020Remove dest:|r", source, "|cff208020to|r", dest)
						end
					end
					...
					if renamedDest then
						...
						if debug then
							found = true
							removed = removed + 1
							PrintD(faction, "|cff808020Remove|r", factionData[dest] or "|cff808020renamed", "|cff808020dest:|r", source, "|cff208020to|r", dest)
						end
					end
				end
				...
				if renamedSource then
					...
					if InFlightVars[faction][source] then
						...
						if debug then
							found = true
							removed = removed + 1
							PrintD(faction, "|cff808020Remove|r", factionData[source] or "|cff808020renamed", "|cff808020source:|r", source)
						end
					end
				end
				...
				if InFlightVars[faction][source] and next(InFlightVars[faction][source]) == nil then
					...
					if debug then
						found = true
						removed = removed + 1
						PrintD(faction, "|cff808020Remove empty source:|r", source)
					end
				end
			end
