...
L["dialog.tooltip.findnumber"] = "filtrez les nombres dans la description"
L["dialog.tooltip.example"] = "Example"
L["dialog.tooltip.name"] = "nom (gros texte blanc)"
L["dialog.tooltip.comment"] = "commentaire (text gris)"
...
L["dialog.tooltip.partialid"] = "instances où j'ai une ID partielle"
L["dialog.tooltip.fullid"] = "instances où j'ai tué tous les boss"
