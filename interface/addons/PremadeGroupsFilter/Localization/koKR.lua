...
L["dialog.tooltip.findnumber"] = "설명에서 숫자를 필터링합니다"
L["dialog.tooltip.example"] = "예제"
L["dialog.tooltip.name"] = "이름 (큰 흰색 문자)"
L["dialog.tooltip.comment"] = "세부 정보 (회색 문자)"
...
L["dialog.tooltip.partialid"] = "일부 귀속된 인스턴스"
L["dialog.tooltip.fullid"] = "모든 우두머리를 처치한 인스턴스"
