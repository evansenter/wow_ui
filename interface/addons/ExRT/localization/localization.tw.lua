...
NEW.NoteOnlyPromoted = "Only trusted"
NEW.NoteOnlyPromotedTooltip = "Take notes updates only from the raid leader or raid officers"
NEW.NoteTabCopyTooltip = "Hold down SHIFT key to copy the current note to this draft"
NEW.NoteSelf = "Personal note"
NEW.NoteSelfTooltip = "Will be shown after note only for you"
NEW.NoteAdd = "Add"
NEW.NoteRemove = "Remove draft"
NEW.NoteDraftName = "Note name"
NEW.NoteOtherIcons = "Other icons"
...
L.BossmodsResetPosTooltip = "Move all frames-bossmods to the center of the screen"	
...
L.BossmodsKoraghHelp = "Help with |TInterface\\Icons\\spell_fire_felfirenova:0|t Expel Magic: Fel debuff"	
NEW.BossmodsKromogTest = "Test"
...
L.raidcheckslak = "在團隊確認時發送食物及藥劑檢查結果"	
...
L.cd2ColSetTextTooltip = "在上方輸入指令，例:|n|cff00ff00%name%|r - 玩家名稱|n|cff00ff00%time%|r - 冷卻時間|n|cff00ff00%name_time%|r - 玩家名稱，如冷卻中則顯示冷卻時間|n|cff00ff00%spell%|r - 法術名稱|n|cff00ff00%stime%|r - 簡短冷卻時間|n|cff00ff00%name_stime%|r - 玩家名稱，如冷卻中則顯示簡短冷卻時間|n|cff00ff00%status%|r - 死亡或離線狀態"	
L.cd2ColSetMethodCooldown = "於圖示上顯示冷卻特效"	
L.cd2ColSetTextIconName = "於圖示上顯示玩家名稱"	
L.cd2ColSetColsInCol = "每一行的列數"	
...
L.cd2HelpFastSetup = "Quick start! Turn on module, move frame with cooldowns to the desired location and don't forget to fixate it. Use buttons of \"Fast Setup\" for adding spells."	
L.cd2HelpOnOff = "Enable spells to start tracking"	
L.cd2HelpCol = "Select the class"	
L.cd2HelpPriority = "Select priority. Spell with lowest priority number will be shown above the rest"	
L.cd2HelpTime = "Set cooldown, duration and column. (* There are some restrictions for base spells)"	
L.cd2HelpColSetup = "Personal settings for each column. Don't forget to \"enable\" them."	
L.cd2HelpTestButton = L.cd2GeneralSetTestMode	
L.cd2HelpButtonDefault = "Reset all settings for selected column to defaults"	
L.cd2HelpAddButton = "Add custom spells. Scroll page down and click \"".. L.cd2AddSpell .."\". Set spell ID in first edit box, select the class, and then press button \"".. L.cd2ButtonModify .."\" for change CD, duration and column."	
L.cd2HelpHistory = "History of usage all spells."	
...
NEW.cd2Racial = "Racial"
NEW.cd2Items = "Items"
NEW.cd2OtherSetHideSpark = "Hide \"spark\""
...
L.BossWatcherSegmentSelectAll = "選擇全部"	
L.BossWatcherSegmentSelectNothing = "不選擇全何"	
...
L.BossWatcherBuffsAndDebuffsFilterEditBoxTooltip = "每一行輸入一個法術"	
...
L.BossWatcherAll = "所有"	
L.BossWatcherDamageDamageDone = "造成傷害"	
...
L.InspectViewerColorizeLowIlvl = "高亮物品等級600以下的裝備"	
...
NEW.SkadaDamageToCurrentTarget = "Damge to the current target"
...
L.TranslateBy = "永霜 at TW-Wrathbringer"	
