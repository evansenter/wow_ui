...
AngryAssign_Pages = {
	...
	[1677668184] = {
		...
		["Id"] = 1677668184,
		["UpdateId"] = 1376034806,
		["Contents"] = "Stone Breath CDs will be rotated (AKA throughput CDs)\n\n1 - Loki Amp\n2 - Vampally Devo/ Toppies Amp\n3 - Divine Hymn\n4 - Revival/ Goargrim Rally (Coming out of the Hands)\n5 - Healing Tide\n6 - Barrier (Ranged Stack)/ AMZ (Melee Stack)\n\nAll other Healing CDs are free to use as see fit\n\nFoxes needs to be used on Stone coming out of ground.\n\nAssign DPS to particular pillars",
	},
}
AngryAssign_State = {
	["tree"] = {
